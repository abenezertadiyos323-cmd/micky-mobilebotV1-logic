...
const product_context = {
  brand: session.collected_constraints?.brand ?? null,
  model: referredTo ?? session.collected_constraints?.model ?? null,
  storage: session.collected_constraints?.storage ?? null,
  condition: session.collected_constraints?.condition ?? null,
  budget_etb: session.collected_constraints?.budget_etb ?? null,
};
